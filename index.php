...
<head>
<meta charset="utf-8">
<title><?php echo $setting['site_name']; ?> - 05.09.01</title>
            ...
            <div class="content-wrapper">
                ...
                <div class="contact-widget">
                    <div class="icon-box">
                        ...
                        <div class="text">Jl. Dr. Wahidin No.12 Ngawi<br> Jawa Timur</div>
                    </div>
                    <div class="icon-box">
                        <div class="icon"><span class="flaticon-calling"></span></div>
                        <div class="text"><strong>Phone</strong><a href="tel:+1234567890">+1234567890</a></div>
                    </div>
                    <div class="icon-box">
                        <div class="icon"><span class="flaticon-mail"></span></div>
                        <div class="text"><strong>Email</strong><a href="tel:+1234567890">dktngawi@gmail.com</a></div>
                    </div>
                </div>
                <!-- Link Btn
    ...
    <section class="banner-section">
        ...
        <div class="background-text">
            <div data-parallax='{"x": 100}'>
                <div class="text-1">Polkes</div>
                <div class="text-2">Polkes</div>
            </div>                
        </div>
                    ...
                    <div class="content-outer">
                        <div class="content-box">
                            <div class="inner text-center">
                                ...
                                <div class="text">Kami mengutamakan pelayanan yang berkualitas bagi masyarakat</div>
                                <!--<div class="link-box">
                ...
                <div class="swiper-slide" style="background-image: url(assets/images/main-slider/image-2.png);">
                    <div class="content-outer">
                        <div class="content-box">
                            <div class="inner text-center">
                                <h4></h4>
                                <h1>Klinik yang terjangkau</h1>
                                <div class="text">Kami sahabat masyarakat yang mengedepankan kesehatan pasien</div>
                                <!--<div class="link-box">
                                    <a href="#" class="theme-btn btn-style-one"><span><i class="flaticon-up-arrow"></i>More Details </span></a>
                                </div>-->
                            </div>                               
                ...
                <div class="swiper-slide" style="background-image: url(assets/images/main-slider/image-3.png);">
                    <div class="content-outer">
                        <div class="content-box">
                            <div class="inner text-center">
                                <h4></h4>
                                <h1>Kesehatan adalah prioritas</h1>
                                <div class="text">Kami berorientasi untuk mendahulukan kepuasan masyarakat</div>
                                <!--<div class="link-box">
                                    <a href="#" class="theme-btn btn-style-one"><span><i class="flaticon-up-arrow"></i>More Details </span></a>
                                </div>-->
                            </div>                       
    ...
    <!-- serivice from here -->
        ...
        <div class="auto-container">
            <div class="sec-title text-center">
                <div class="sub-title">Pelayanan Utama</div>
                <h2>Kami Melayani Anda<br>Dengan Sepenuh Hati</h2>
            </div>
...
.zoom:hover {
  transform: scale(1.02); /* (150% zoom - Note: if the zoom is too large, it will go outside of the viewport) */
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="sec-title">
                        ...
                        <h2>Polkes DKT 05.09.01<br>Ngawi</h2>
                        <div class="text">Salah satu bentuk pelayanan kesehatan yang diberikan Denkesyah 04.05.01 Madiun di wilayah Ngawi yaitu dengan dibentuknya Polkes disetiap Kabupaten, guna mempermudah memberikan pelayanan kesehatan dan dukungan kesehatan bagi seluruh anggota militer, PNS, dan keluarga yang berada diwilayah tersebut. Salah satunya yaitu Poliklinik Kesehatan 05.09.01 (Polkes 05.09.01) Ngawi yang berada diwilayah Kodim 0805 Ngawi.</div>
                        <a href="about.php" class="readmore-link"><i class="flaticon-up-arrow"></i>More Details</a>
                    </div>
                    <h3><b>Dukungan Kesehatan Bagi</b></h3><br>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="icon-box wow fadeInUp" data-wow-duration="1500ms">
                                <div class="icon"><span class="flaticon-package"></span></div>
                                <div class="content">
                                    <span><h4>TNI<br>Keluarga</h4></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="icon-box wow fadeInUp" data-wow-duration="1500ms">
                                ...
                                <div class="content">
                                    <span><h4>PNS<br>Keluarga</h4></span>
                        ...
                        <div class="col-md-6">
                            <div class="icon-box wow fadeInUp" data-wow-duration="1700ms">
                                ...
                                <div class="content">
                                    <span><h4>Umum<br>Semua Orang</h4></span>
                                </div>
                            </div>
                        </div>
                        <!--<div class="col-md-6">
                ...
                <div class="col-lg-6">
                    <div class="image wow fadeInRight" data-wow-duration="1500ms"><img src="assets/images/resource/company.png" alt=""></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="Whychooseus-section">
        <div class="auto-container">
            <div class="sec-title text-center">
                <div class="sub-title text-center">Kenapa Memilih Kami</div>
                <h2>Kami Bertujuan Untuk <br>Berkontribusi Baik Bagi Kesehatanmu</h2>
            </div>
            <div class="row">
                <div class="col-lg-6 col-md-6 why-choose-block">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                        <div class="icon"><span class="count">01</span><i class="fa fa-plus-square"></i></div>
                        <div class="content">
                            <h4>Melayani BPJS / Umum</h4>
                ...
                <div class="col-lg-6 col-md-6 why-choose-block">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                        <div class="icon"><span class="count">02</span><i class="fa fa-heartbeat"></i></div>
                        <div class="content">
                            <h4>Klinik Yang Terjangkau</h4>
                ...
                <div class="col-lg-6 col-md-6 why-choose-block">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                        <div class="icon"><span class="count">03</span><i class="fa fa-stethoscope"></i></div>
                        <div class="content">
                            <h4>Standart Alat Medis Berkualitas</h4>
                ...
                <div class="col-lg-6 col-md-6 why-choose-block">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                        <div class="icon"><span class="count">04</span><i class="fa fa-check-square"></i></div>
                        <div class="content">
                            <h4>Dukungan Kesehatan Sesuai SOP</h4>
    ...
    <section class="work-process-section">
        ...
        <div class="auto-container">
            <div class="sec-title text-center light">
                <div class="sub-title text-center">Bagaimana Kami Bekerja</div>
                <h2>Dapat Melalui Pendaftaran Online<br>Ikuti Tahapannya</h2>
            </div>
            <div class="row">
                <div class="col-lg-3 col-md-6 work-process-block">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                        ...
                        <h4>Klik Link <br> Daftar Online</h4>
                ...
                <div class="col-lg-3 col-md-6 work-process-block">
                    <div class="inner-box wow fadeInDwon" data-wow-duration="1500ms">
                        ...
                        <h4>Isi Data Diri <br> di Form</h4>
                ...
                <div class="col-lg-3 col-md-6 work-process-block">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                        ...
                        <h4>Teliti Data <br> Sebelum Daftar Ulang</h4>
                ...
                <div class="col-lg-3 col-md-6 work-process-block">
                    <div class="inner-box wow fadeInDown" data-wow-duration="1500ms">
                        ...
                        <h4>Lakukan Pemeriksaan<br> Yang Dibutuhkan</h4>
    ...
    <section class="testimonials-section">
        <div class="auto-container">
            <div class="sec-title text-center">
                <div class="sub-title text-center">Dokter Jaga</div>
                <h2>We do the best for your helathy</h2>
            </div>
